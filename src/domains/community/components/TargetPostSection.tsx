...
function TargetPostSection() {
  return (
    <section className="w-full grid grid-cols-1 gap-6 md:grid-cols-2">
      ...
      <TargetPostList category="ALL" sort="LATEST" title="전체 최근 게시글"/>
      <TargetPostList category="SCENARIO" sort="LATEST" title="시나리오 최근 게시글"/>
      <TargetPostList category="POLL" sort="LATEST" title="투표 최근 게시글"/>
      <TargetPostList category="CHAT" sort="LATEST" title="잡담 최근 게시글"/>
    </section>
  );
}
